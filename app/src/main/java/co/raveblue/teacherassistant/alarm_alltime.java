...
public class alarm_alltime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alarm_alltime);
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public VerticalItemHolder onCreateViewHolder(ViewGroup container, int viewType) {
            ...
            View root = inflater.inflate(R.layout.alarm_row, container, false);
        ...
        public  class VerticalItemHolder extends SwappingHolder
            ...
            public boolean onLongClick(View v) {
                AppCompatActivity activity = alarm_alltime.this;
